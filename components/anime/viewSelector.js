    ...
    <div className="flex gap-3 rounded-sm items-center p-2">
      ...
      >
        <svg
          ...
          viewBox="0 0 33 20"
        >
          <rect width="8" height="8" x="1" y="1" rx="2"></rect>
          <rect width="8" height="8" x="12" y="1" rx="2"></rect>
          <rect width="8" height="8" x="23" y="1" rx="2"></rect>
          <rect width="8" height="8" x="1" y="11" rx="2"></rect>
          <rect width="8" height="8" x="12" y="11" rx="2"></rect>
          <rect width="8" height="8" x="23" y="11" rx="2"></rect>
        </svg>
      </div>
    </div>
  );
